...
///bar的高度
static const CGFloat wVideoControlBarHeight = 40.0;
///动画时间
static const CGFloat wVideoControlAnimationTimeinterval = 0.3;
///10号字
static const CGFloat wVideoControlTimeLabelFontSize = 10.0;
///自动隐藏5s
static const CGFloat wVideoControlBarAutoFadeOutTimeinterval = 5.0;

@interface WWLJPlayerView ()
///bar是否隐藏
...
- (void)layoutSubviews
{
    ...
    self.topBar.frame = CGRectMake(CGRectGetMinX(self.bounds), CGRectGetMinY(self.bounds), CGRectGetWidth(self.bounds), wVideoControlBarHeight);
    ...
    self.bottomBar.frame = CGRectMake(CGRectGetMinX(self.bounds), CGRectGetHeight(self.bounds) - wVideoControlBarHeight, CGRectGetWidth(self.bounds), wVideoControlBarHeight);
...
- (void)animateHide
{
    ...
    [UIView animateWithDuration:wVideoControlAnimationTimeinterval animations:^{
...
- (void)autoFadeOutControlBar
{
    ...
    [self performSelector:@selector(animateHide) withObject:nil afterDelay:wVideoControlBarAutoFadeOutTimeinterval];
}
...
- (UIButton *)playButton
{
    if (!_playButton) {
        ...
        _playButton.bounds = CGRectMake(0, 0, wVideoControlBarHeight, wVideoControlBarHeight);
    }
    return _playButton;
}
...
- (UIButton *)pauseButton
{
    if (!_pauseButton) {
        ...
        _pauseButton.bounds = CGRectMake(0, 0, wVideoControlBarHeight, wVideoControlBarHeight);
    }
    return _pauseButton;
}
...
- (UIButton *)fullScreenButton
{
    if (!_fullScreenButton) {
        ...
        _fullScreenButton.bounds = CGRectMake(0, 0, wVideoControlBarHeight, wVideoControlBarHeight);
    }
...
- (UIButton *)shrinkScreenButton
{
    if (!_shrinkScreenButton) {
        ...
        _shrinkScreenButton.bounds = CGRectMake(0, 0, wVideoControlBarHeight, wVideoControlBarHeight);
    }
...
- (UIButton *)closeButton
{
    if (!_closeButton) {
        ...
        _closeButton.bounds = CGRectMake(0, 0, wVideoControlBarHeight, wVideoControlBarHeight);
    }
    return _closeButton;
}
...
- (UILabel *)timeLabel
{
    if (!_timeLabel) {
        ...
        _timeLabel.font = [UIFont systemFontOfSize:wVideoControlTimeLabelFontSize];
        _timeLabel.textColor = [UIColor whiteColor];
        _timeLabel.textAlignment = NSTextAlignmentRight;
        _timeLabel.bounds = CGRectMake(0, 0, wVideoControlTimeLabelFontSize, wVideoControlTimeLabelFontSize);
    }
    return _timeLabel;
}
